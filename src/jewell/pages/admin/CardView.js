...
const CardView = React.forwardRef((props, ref) => {
    ...
    return (
        <>
            {/* <h6 className="fs-16"><i title="Gender" className="fa-solid fa-transgender fs-20 ps-2 me-2 blue wd-30"></i>{element.gender}</h6> */}
            ...
            <div className="d-flex">
                <div><i title="Address" className="fa-solid fa-globe fs-16 ps-2 me-1 light-blue wd-30"></i></div>
                <div className="ps-1 fs-12 fw-normal">
                    {element.address},<br />
                    {element.city},<br />{element.state}</div>
            </div>
            <div className="d-flex pt-2">
                <div><i title="Notes" className="fa-solid fa-sticky-note fs-16 ps-2 me-1 grey wd-30"></i></div>
