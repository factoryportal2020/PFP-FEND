...
const CardView = React.forwardRef((props, ref) => {
    ...
    return (
        <>
            {/* <h6 className="fs-12"><i title="Gender" className="fa-solid fa-transgender fs-18 ps-2 me-2 blue wd-30"></i>{element.gender}</h6> */}
            ...
            <div className="d-flex">
                ...
                <div className="ps-1 fs-12 fw-normal">{(element.address) ? element.address + "," : ""}<br />
