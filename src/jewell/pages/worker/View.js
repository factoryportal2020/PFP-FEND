                            ...
                            <div className="card w-auto mt-4">
                                <div className="card-body ps-3 pe-5">
                                    <div className="card-content">
                                        ...
                                        <div className='row'>
                                            {
                                                Object.keys(param.tasks_count).map(function (key, index) {
                                                    let task_name = (validator.replaceUnderscore(validator.toCapitalize(key))).replace("count", "");
                                                    return (
                                                        <div className="col-sm pb-2">
                                                            <div className="d-flex">
                                                                <div className="fs-14 grey">{task_name}</div>
                                                                <div className="ps-1 fs-14">{param.tasks_count[key]}</div>
                                                            </div>
                                                        </div>
                                                    )
                                            ...
                                            <div className="form-group">
                                                <Link role="button" type="button"
                                                    ...
                                                    to="/task/list"
                                                    className="view__btn float-end">View Tasks</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
