...
// auth
import { saveResetPassword } from '../../../features/auth/webAuctions';
...
class ResetPassword extends React.Component {
    constructor(props) {
        ...
        console.log(this.state.adminAuth)
    }
    ...
    componentDidMount() {
        //Edit
        let token = (window.location.pathname.split('/')[4]) ? window.location.pathname.split('/')[4] : null;
